/**
 * ProviderNavigationClient.tsx
 * Client-side reusable navigation component for provider dashboard pages
...
interface ProviderNavigationClientProps {
  title: string
  currentPage?: 'dashboard' | 'my-schedule' | 'provider-bookings' | 'my-profile' | 'settings'
}

export default function ProviderNavigationClient({ title, currentPage }: ProviderNavigationClientProps) {
